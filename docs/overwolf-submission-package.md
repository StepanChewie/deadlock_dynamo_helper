...
## 1. Черновик заявки на идею

Форма: <https://dev.overwolf.com/app-idea-form> (нужен вход в аккаунт Overwolf).
...
- [ ] Ответ DevRel по монетизации получен (раздел 0)
- [ ] Заявка на идею одобрена
